...
<div id={hash} class="fixed inset-0 hidden items-center justify-center bg-black/60 target:flex">
	<div
		class={twMerge(
		...
		<div class="flex flex-col gap-y-1">
			...
			<a
				...
				class={twMerge(
					...
					close == 'center' ? 'order-1 flex justify-center' : 'absolute top-2 right-2'
				)}>Close</a
			>
		</div>
	</div>
